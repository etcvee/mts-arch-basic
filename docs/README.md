...
| ------ | ------------------------------------------------------------------------------- |
| FR.001 | Система должна позволять регистрировать докладчиков конференции                 |
| FR.002 | Система должна авторизировать докладчиков по EMail и паролю                     |
| FR.003 | Система должна позволять подать доклад на рассмотрение программным комитетом    |
| FR.004 | Система должна отображать  список докладов, которые были поданы на рассмотрение |
| FR.005 | Система должна отображать статус рассмотрения доклада программным комитетом     |
| FR.006 | Система должна позволять загрузить исправленную версию презентации доклада      |
| FR.007 | Система должна позволять отозвать доклад с рассмотрения,                        |
| FR.008 | Система должна уведомлять об утверждении или отклонении доклада                 |
| FR.009 | Система должна отображать список докладов, которые необходимо рассмотреть       |
| FR.010 | Система должна авторизировать экспертов по EMail и паролю                       |
| FR.011 | Система должна позволять взять доклад на рассмотрение                           |
| FR.012 | Система должна позволять утвердить доклад                                       |
| FR.013 | Система должна позволять отклонить некачественный доклад                        |
| FR.014 | Система должна позволять эксперту дать обратную связь докладчику                |
| FR.015 | Система должна отображать расписание выступлений                                |
| FR.016 | Система должна позволять добавить доклад в расписание конфереции                |
| FR.017 | Система должна позволять изменять время выступления                             |
| FR.018 | Система должна позволять изменять место выступления                             |
| FR.019 | Система должна позволять удалять доклады из расписания                          |
| FR.020 | Система должна позволять участникам регистрироваться на конференции             |
| FR.021 | Система должна авторизировать участников по EMail и паролю                      |
| FR.022 | Система должна транслировать выступления онлайн                                 |
| FR.023 | Система должна позволять участнкам оценивать доклады                            |
